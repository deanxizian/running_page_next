...
- GitHub Pages: `.github/workflows/gh-pages.yml` deploys automatically on pushes to `main` or `master` that affect the site. For the first deployment in a new repository, enable GitHub Pages in repository settings and set the source to GitHub Actions.
